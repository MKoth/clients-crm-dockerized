    ...
    <>
      ...
      <div style={{padding:15, maxWidth:330}}>
        <Grid container spacing={1}>
          ...
          <Grid item xs={12}>
            <Button fullWidth variant="outlined" color="primary" onClick={()=>{onPaymentChange('credit_card')}} startIcon={<DoubleArrowIcon />}>Credit card</Button>
          </Grid>
          <Grid item xs={12}>
            <Button fullWidth variant="outlined" color="primary" onClick={()=>{onPaymentChange('paypal')}} startIcon={<DoubleArrowIcon />}>PayPal</Button>
          </Grid>*/}
          <Grid item xs={12} style={{marginTop:20}}>
            <Typography>Pay later with:</Typography>
          </Grid>
          <Grid item xs={12}>
            <Button fullWidth variant="outlined" color="primary" onClick={()=>{onPaymentChange('cash')}} startIcon={<DoubleArrowIcon />}>Cash</Button>
          </Grid>
        </Grid>
      </div>
