...
class CategoryEdit extends Component {
  ...
  handleChecked(e, staff){
    if(e.target.checked){
      this.state.staff_service_field.push({staff:staff.id});
    }
    else{
      let remove_staff = this.state.staff_service_field.find(ssf=>ssf.staff===staff.id);
      let index = this.state.staff_service_field.indexOf(remove_staff);
      this.state.staff_service_field.splice(index, 1);
    }
    this.setState({
              ...
              <Paper elevation={0} style={{padding:15}}>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item sm={5} xs={12}>
                    <FormControl fullWidth variant="outlined" size="small">
                      <InputLabel id="service-select-category">Category</InputLabel>
                      <Select
                        ...
                        label="Category"
                      >
                        <MenuItem value={'women'}>Women haircut</MenuItem>
                        <MenuItem value={'man'}>Man haircut</MenuItem>
                      </Select>
                    </FormControl>
                  </Grid>
                  <Grid item sm={7} xs={12}>
                  ...
                  <Grid item sm={5} xs={12}>
                    <FormControl fullWidth variant="outlined" size="small">
                      ...
                      >
                        ...
                        <MenuItem value={'individuals'}>For individuals</MenuItem>
                      </Select>
                    </FormControl>
                  </Grid>
                  <Grid item sm={7} xs={12}>
                ...
                <FormControl component="fieldset">
                  <FormGroup>
                    {this.props.staffs.map(staff=><FormControlLabel
                      key={staff.id}
                      control={<Checkbox 
                        checked={this.state.staff_service_field.find(ssf=>ssf.staff===staff.id)} 
